...
if uploaded_file1 is not None and uploaded_file2 is not None:
    ...
    tokenizer = AutoTokenizer.from_pretrained('sentence-transformers/all-mpnet-base-v2')#('sentence-transformers/bert-base-nli-mean-tokens')
    model = AutoModel.from_pretrained('sentence-transformers/all-mpnet-base-v2')#('sentence-transformers/bert-base-nli-mean-tokens')
